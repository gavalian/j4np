 ...
 * @author gavalian
 */
public class ExtractFeaturesLSVM extends ExtractModule {
    Random r = new Random();
    public ExtractFeaturesLSVM(String file){
        super(file);
    }
    
    public ExtractFeaturesLSVM(String... files){
        super(files);
    }
    @Override
            ...
            if(tSector.size()==2){
                ...
                if(tv.size()==2){
                    ...
                    String data1 = String.format("%d %s",label_1,
                            reader.toDataString(dc_1.getFeatures6()));
                    String data2 = String.format("%d %s",label_2,
                            reader.toDataString(dc_2.getFeatures6()));

                    String data12 = String.format("%d %s",0,
                            reader.toDataString(dc_1_2.getFeatures6()));
                    ...
                    String data1_36 = String.format("%d %s",label_1,
                            reader.toDataString(dc_1.getFeatures36()));
                    String data2_36 = String.format("%d %s",label_2,
                    ...
                    String data1_12 = String.format("%d %s",label_1,
                            reader.toDataString(dc_1.getFeatures12()));
                    String data2_12 = String.format("%d %s",label_2,
                            reader.toDataString(dc_2.getFeatures12()));
