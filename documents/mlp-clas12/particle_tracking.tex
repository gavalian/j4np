...
\caption {Example of signals in drift chambers for four events. Each plot represents one sector (from 
different events) with a 36x112 matrix of wires. Background hits (in gray) are shown along with the 
hits of reconstructed identified tracks (in red). Dashed lines represent boundaries between super-layers.}
...
Tracking is computationally intensive and makes up $80\%-90\%$ (depending on background conditions 
