\section{Analysis of De-Noising data with AI assistance}
...
It is evident from these studies that the analysis of existing data can benefit from this approach to tracking by an increase 
...
%the CLAS12 detector. The summary of the number of reconstructed protons in the missing mass peak for
...
%As can be seen in the table conducting an experiment with $95~nA$ beam current and processing the data using artificial 
%intelligence (both de-noising and AI-assisted tracking) leads to more events in the missing 
%mass peak compared to running at $45~nA$ and reconstructing with the conventional tracking algorithm. 
Conducting experiments with $95~nA$ incident beam energy will take twice less time to accumulate the same number 
