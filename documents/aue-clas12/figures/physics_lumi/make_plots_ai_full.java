...
h45_3.attr().setLineColor(7);
h45_3.attr().setFillColor(57);

h95_1.attr().setLineColor(9);
h95_1.attr().setFillColor(39);
h95_3.attr().setLineColor(7);
h95_3.attr().setFillColor(57);

h150_1.attr().setLineColor(9);
h150_1.attr().setFillColor(39);
h150_3.attr().setLineColor(7);
h150_3.attr().setFillColor(57);
...
c.view().region(1).draw(h45_3).draw(h45_1,"same").draw(h00_0,"same").joinX().wrapX();
c.view().region(2).draw(h95_3).draw(h95_1,"same").draw(h00_0,"same").joinX().wrapX();
c.view().region(3).draw(h150_3).draw(h150_1,"same").draw(h00_0,"same").wrapX();
...
cr.view().region(1).draw(grc,"PL").draw(grd,"PLsame").draw(gra,"PLsame").draw(grca,"PLsame").wrapX();
