...
public class TPalette2D {
    ...
    public TPalette2D(PaletteName pn){
        this.setPalette(pn);
    }
    ...
    public final void setPalette(String palName) {
    ...
    public final void setPalette(PaletteName palette) {
        ...
        switch (palette) {
            ...
            case kWaterMelon: {
                double red[] = {   255., 200., 120.,  88.,  118., 147., 175., 187., 205.};
                double green[] = { 255., 220., 145., 125.,  154., 169., 161., 129., 70.};
                double blue[] =  { 255., 200., 120.,  70.,  100., 128., 145., 130., 75.};
                CreateGradientColorTable(red, green, blue);
            }
            break;
