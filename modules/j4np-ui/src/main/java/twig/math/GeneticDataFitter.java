...
public class GeneticDataFitter {
    ...
    public void initFunction(double min, double max){
        func =  new F1D("func","[a]*(1.0+[b]*x+[c]*x*x + gaus(x,[m],[s]))",min,max);
    }
    ...
    private Population<GenFunction> createInitialPopulation(int populationSize,
        ...
        GenFunction base = new GenFunction("[a]+[c]*gaus(x,[m],[s])", min,max);
...
*/
  ...
  */      
    public static void main(String[] args){
        ...
        H1F h = TDataFactory.createH1F(22000, 240, 0.0, 1.0, 0.25, 0.005);
        ...
        gf.fit(h, 0.1,0.75);
        gf.gfunc.function.attr().set("lc=5,lw=4,ls=2");
