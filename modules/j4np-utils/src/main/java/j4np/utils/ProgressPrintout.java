...
public class ProgressPrintout {
    ...
    public int  getCounter(){ return this.numberOfCalls;}
    ...
    public static String timeStringFromNano(long nsec){
        ...
        if(seconds<60) return String.format("%d sec", (int) seconds);
        
        if(seconds<3600){
            int  minutes = (int) (seconds/60.0);
            int leftover = ((int) seconds)%60;
            return String.format("%02d:%02d min", minutes,leftover);
        } 
