...
public class FileEventIndex {
    ...
    public String statusString(){
        String format = "[file-index] >> index = (%8d,%8d) , event = %6d, entries = %8d, records = %d, can advance = " + this.canAdvance();
        return String.format(format,this.currentEvent,
                this.currentRecord, this.currentRecordEvent,
                this.getMaxEvents(), this.recordIndex.size());
    }
