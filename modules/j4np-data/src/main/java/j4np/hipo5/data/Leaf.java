 ...
 * @author gavalian
 */
public class Leaf extends BaseHipoStructure {
    ...
    public Leaf(String format, int rows){
    ...
    public Leaf putInt( int entry,int row, int number){
    ...
    public Leaf putLong(int entry, int row, long number){
    ...
    public Leaf putByte(int entry, int row, byte number){
    ...
    public Leaf putShort(int entry, int row,  short number){
    ...
    public Leaf putFloat(int entry, int row, float number){
    ...
    public Leaf putDouble(int entry, int row, double number){
