...
/**
 * PDG database class. Stores particle information in a Map. 
 * Particles information can be searched by LUND ID, GEANT ID, 
 * or simply the name of the particle.
 * 
 * @author gavalian
 */
public class PDGDatabase {
	...
	private static HashMap<Integer, PDGParticle> initDatabase() {
		...
		particleMap.put(113, new PDGParticle("rho0", 113, 0.7754, 0, 0.1491));
		...
		particleMap.put(213, new PDGParticle("rho+", 213, 0.7754, 1, 0.1491));
